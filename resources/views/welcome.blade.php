            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <svg width="2.5rem" height="2.5rem" viewBox="0 0 192.756 192.756" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="/#" class="text-gray-900 dark:text-white text-lg font-semibold;" style="margin-left: 2rem;">
                            R4 Club België
                        </a>
                ...
                <div class="hidden sm:flex sm:items-center">
                    <form method="GET" action="{{ route('login') }}">
                        <button type="submit" class="text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium">Log In</button>
                    </form>
                    
                    <form method="GET" action="{{ route('register') }}" class="ml-4">
                        <button type="submit" class="text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium">Register</button>
                    </form>
                </div>
